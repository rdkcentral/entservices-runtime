...
# Instruction summary
  ...
  4. [Handling Out-of-Process Plugin Failures](https://github.com/rdkcentral/entservices-runtime/blob/develop/.github/instructions/Plugin.instructions.md#handling-out-of-process-plugin-failures)
